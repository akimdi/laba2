        ...
        #ifndef ADB_GENERATEUNSUBSCRIBEEVENTRESPONSE_H
        #define ADB_GENERATEUNSUBSCRIBEEVENTRESPONSE_H

       /**
        * adb_generateUnsubscribeEventResponse.h
        *
       ...
       /**
        *  adb_generateUnsubscribeEventResponse class
        */
        ...
        typedef struct adb_generateUnsubscribeEventResponse adb_generateUnsubscribeEventResponse_t;
        ...
        /**
         * Constructor for creating adb_generateUnsubscribeEventResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_generateUnsubscribeEventResponse_t object
         */
         ...
         * @param  _generateUnsubscribeEventResponse adb_generateUnsubscribeEventResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_generateUnsubscribeEventResponse_t object
         * @param  _generateUnsubscribeEventResponse adb_generateUnsubscribeEventResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for message. 
         * @param  _generateUnsubscribeEventResponse adb_generateUnsubscribeEventResponse_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_generateUnsubscribeEventResponse_declare_parent_namespaces(
         ...
         * @param  _generateUnsubscribeEventResponse adb_generateUnsubscribeEventResponse_t object
         * @param env pointer to environment struct
         * @param generateUnsubscribeEventResponse_om_node node to serialize from
         * @param generateUnsubscribeEventResponse_om_element parent element to serialize from
        ...
        adb_generateUnsubscribeEventResponse_serialize(
            adb_generateUnsubscribeEventResponse_t* _generateUnsubscribeEventResponse,
            const axutil_env_t *env,
            axiom_node_t* generateUnsubscribeEventResponse_om_node, axiom_element_t *generateUnsubscribeEventResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_generateUnsubscribeEventResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_generateUnsubscribeEventResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_generateUnsubscribeEventResponse_t object and return the property value.
     ...
     #endif /* ADB_GENERATEUNSUBSCRIBEEVENTRESPONSE_H */
