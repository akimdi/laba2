/**
         ...
         * by the Apache Axis2 version: 1.6.2  Built on : Mar 14, 2013 (10:39:28 MSK)
...
int AXIS2_CALL
axis2_svc_skel_Subscribers_init_with_conf(
        axis2_svc_skeleton_t * svc_skeleton,
        const axutil_env_t * env,
...
int AXIS2_CALL
axis2_svc_skel_Subscribers_init_with_conf(axis2_svc_skeleton_t * svc_skeleton,
                                  const axutil_env_t * env, struct axis2_conf * conf)
{
    subscribeTo(env, conf);
...
//	env = axutil_env_create_all("subscribers.log", AXIS2_LOG_LEVEL_TRACE);
	...
	printf("%s\n", adb_unsubscribeResponse_get_message(unsubscribeResponse, env));
