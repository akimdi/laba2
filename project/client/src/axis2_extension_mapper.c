            ...
            axis2_char_t *default_type)
        {
            ...
            if (type != NULL)
            {
              ...
              if (axutil_strcmp(type, "message") == 0)
              {
                  return (adb_type_t*) adb_message_create(env);
              }
              
            }

            
            if (axutil_strcmp(default_type, "adb_message") == 0)
            {
                return (adb_type_t*) adb_message_create(env);
            }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_message") == 0)
                {
                    return adb_message_free_obj(
                    (adb_message_t*) _object, env);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_message") == 0)
                {
                    return adb_message_deserialize_obj(
                    (adb_message_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_message") == 0)
                {
                    ...
                    (adb_message_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
